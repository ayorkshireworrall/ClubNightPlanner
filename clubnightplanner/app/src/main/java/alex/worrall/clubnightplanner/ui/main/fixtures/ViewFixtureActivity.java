...
public class ViewFixtureActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_fixture);
        Toolbar toolbar = findViewById(R.id.toolbarViewFixture);
