...
public class SchedulerTest {
    ...
    public void testGenerateSchedule() {
        ...
        scheduler.generateSchedule(1000, courtNames);
        assertEqualPlayTime();
        scheduler.generateSchedule(1020, courtNames);
        assertEqualPlayTime();
        courtNames.add("Court6");
        courtNames.add("Court7");
        scheduler.generateSchedule(1040, courtNames);
        assertEqualPlayTime();
        scheduler.generateSchedule(1100, courtNames);
        assertEqualPlayTime();
    ...
    public void testAddPlayer() {
        ...
        scheduler.generateSchedule(1040, courtNames);
        scheduler.generateSchedule(1100, courtNames);
        scheduler.markScheduleComplete(dataHolder.getFixtures().get(1000));
        scheduler.markScheduleComplete(dataHolder.getFixtures().get(1020));
    ...
    public void testDisableCourt() {
        ...
        Fixture fixture1 = dataHolder.getFixtures().get(1000);
        Fixture fixture2 = dataHolder.getFixtures().get(1020);
        Fixture fixture3 = dataHolder.getFixtures().get(1040);
        Fixture fixture4 = dataHolder.getFixtures().get(1100);
        assertTrue(fixture1.getCourts().size() == 5);
        assertTrue(fixture2.getCourts().size() == 5);
        assertTrue(fixture3.getCourts().size() == 7);
